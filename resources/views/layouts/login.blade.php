...
<head>                      
    ...
    <meta name="author" content="| Powered by jaissiel@outlook.com | [( Production/Release -> 250424 )] |">
...
<body>
    ...
    <div style="margin-bottom:0px" >
        ...
        <img src="{{ asset('images/i_m_a_g_e_s____◣_◢/BigImages/SELECTED/horizontal_white_jaissiel04_blue.jpg')   }}" style="width:100%" height="200px">
        <img src="{{ asset('images/i_m_a_g_e_s____◣_◢/BigImages/SELECTED/the-mendoza-law-firm-logo_610px.png')   }}"  class="little-image" width="200px" height="200px">
    ...
    <nav class="navbar navbar-expand-sm navbar-dark bg-dark sticky-top">
        <div class="container-fluid">
            ...
            <ul class="navbar-nav me-auto">
                <li class="nav-item">
                <a class="nav-link" href="#articles">Login</a>
                </li>
                <li class="nav-item">
