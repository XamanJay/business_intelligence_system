...
<form action="/employees/{{ $employees->id }}" method="POST" name="employees_edit_form" enctype="multipart/form-data" >
    @csrf
    @method('PUT')
...
<div id="sales" class="container header " style="margin-top:0px">
        ...
        <div class="row" >
            <div class="col-md-12" > 
                    ...
                    <p style="text-align: center;margin-bottom: 2px;margin-top: 2px;">
                        <label> ::::: MODIFICAR EMPLEADOS ::::: </label>
                    </p>
                    <div>
        ...
        <div class="row">
            <div class="col-sm-6">
                ...
                <input id="name" name="name" class="form-control" type="text" value="{{ $employees->name }}" >
            </div>
                
            <div class="col-sm-6">
                <label for="">Apellido Paterno</label>
                <input id="last_name" name="last_name" class="form-control" type="text" value="{{ $employees->last_name }}" >
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-sm-6">
                ...
                <input id="second_last_name" name="second_last_name" class="form-control" type="text" value="{{ $employees->second_last_name }}" >
                
            </div>
                
            <div class="col-sm-6">
                <label for="">Email</label>
                <input id="email" name="email" class="form-control" type="text" value="{{ $employees->email}}">
            </div>
        </div>
        ...
        <div class="row">  
            <div class="col-sm-4">
                ...
                <select id="cat_type_employees_id" name="cat_type_employees_id" class="form-select"> 
                    @foreach ($typeemployees1 as $typeemployees1 )    
                                <option value="{{ $typeemployees1->id }}" selected>{{ $typeemployees1->description }}</option>
                    @endforeach
            ...
            <div class="col-sm-5">
                <label for="image_path" class="label-form"> Observaciones</label>
                    <textarea id="observations" name="observations" class="form-control" required  value=""  size=10 rows=3 cols=35>{{ $employees->observations}} </textarea>
...
<script> 
	...
	function ValidaCampos()  {
        ...
        employees_edit_form.B01.disabled = true; 
		document.employees_edit_form.submit();	  
    }
